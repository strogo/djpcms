...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('djpcms_objectpermission', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='objectpermissions', to=orm['contenttypes.ContentType'])),
            ('content_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('djpcms', ['ObjectPermission'])

        # Adding field 'BlockContent.requires_login'
        db.add_column('djpcms_blockcontent', 'requires_login', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ObjectPermission'
        db.delete_table('djpcms_objectpermission')

        # Deleting field 'BlockContent.requires_login'
        db.delete_column('djpcms_blockcontent', 'requires_login')
