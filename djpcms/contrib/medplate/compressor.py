...
from djpcms.contrib.compressor.conf import settings
from djpcms.contrib.compressor import filters
...
class CssCompressor(Compressor):
    ...
    def __init__(self, content, output_prefix="css"):
        ...
        self.filters = ['djpcms.contrib.compressor.filters.css_default.CssAbsoluteFilter']
