...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlowItem.markup'
        db.add_column('flowrepo_flowitem', 'markup', self.gf('django.db.models.fields.CharField')(default='crl', max_length=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlowItem.markup'
        db.delete_column('flowrepo_flowitem', 'markup')
