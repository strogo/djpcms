...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Category.markup'
        db.delete_column('flowrepo_category', 'markup')

        # Deleting field 'Report.markup'
        db.delete_column('flowrepo_report', 'markup')


    def backwards(self, orm):
        
        # Adding field 'Category.markup'
        db.add_column('flowrepo_category', 'markup', self.gf('django.db.models.fields.CharField')(default='crl', max_length=3, blank=True), keep_default=False)

        # Adding field 'Report.markup'
        db.add_column('flowrepo_report', 'markup', self.gf('django.db.models.fields.CharField')(default='crl', max_length=3, blank=True), keep_default=False)
