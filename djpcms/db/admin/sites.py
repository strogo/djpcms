...
from options import ModelDbAdmin

class DbAdminSite(object):
    """
    A DbAdminSite object encapsulates an instance of the djangosite admin application, ready
    ...
    def register(self, model_or_iterable, admin_class = None, **options):
        """
        Registers the given model(s) with the given dbadmin class.
        ...
        for model in model_or_iterable:
            ...
            if options:
                ...
                admin_class = type("%sDbAdmin" % model.__name__, (admin_class,), options)
